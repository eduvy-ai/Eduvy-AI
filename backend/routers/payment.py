...
PLAN_CONFIG = {
    "basic":   {"amount": 100,  "label": "Basic",   "duration_days": 30},  # ₹1
    "pro":     {"amount": 200,  "label": "Pro",     "duration_days": 30},  # ₹2
    "premium": {"amount": 300,  "label": "Premium", "duration_days": 30},  # ₹3
}
    ...
    try:
        ...
        cursor.execute(
            """INSERT INTO payment_history 
               (user_id, plan, amount, currency, razorpay_order_id, razorpay_payment_id, razorpay_signature, status, plan_expires_at)
