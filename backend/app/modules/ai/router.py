...
@router.get("/teacher-audio/{beat_id}")
async def get_teacher_audio_file(beat_id: str, current_user: str = Depends(get_current_user)):
    """Serve generated Teacher Mode audio file (authenticated)."""
    import os
    import re
    import tempfile
    ...
    audio_dir = os.path.join(tempfile.gettempdir(), "eduvy_teacher_audio", current_user)
