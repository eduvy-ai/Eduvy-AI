...
export const BATTLES = {
  ...
  couldNotJoinBattle: {
    English: "Could not join this battle. It may have been taken.", Hindi: "इस बैटल में शामिल नहीं हो सके। शायद किसी और ने ले ली।", Gujarati: "આ બેટલમાં જોડાઈ શક્યા નથી. કદાચ કોઈએ લઈ લીધી.", Marathi: "या बॅटलमध्ये सामील होऊ शकलो नाही. कदाचित कोणी घेतली.",
    Tamil: "இந்த போட்டியில் சேர முடியவில்லை. ஏற்கனவே எடுக்கப்பட்டிருக்கலாம்.", Telugu: "ఈ బ్యాటిల్‌లో చేరలేకపోయాము. ఇప్పటికే తీసుకోబడి ఉండవచ్చు.", Kannada: "ಈ ಬ್ಯಾಟಲ್‌ಗೆ ಸೇರಲಾಗಲಿಲ್ಲ. ಬಹುಶಃ ಯಾರಾದರೂ ತೆಗೆದುಕೊಂಡಿರಬಹುದು.", Bengali: "এই ব্যাটলে যোগ দিতে পারলাম না। হয়তো অন্য কেউ নিয়ে নিয়েছে।",
    Punjabi: "ਇਸ ਬੈਟਲ ਵਿੱਚ ਸ਼ਾਮਲ ਨਹੀਂ ਹੋ ਸਕੇ। ਸ਼ਾਇਦ ਕਿਸੇ ਹੋਰ ਨੇ ਲੈ ਲਈ।", Odia: "ଏହି ବ୍ୟାଟଲରେ ଯୋଗ ଦେଇ ପାରିଲୁ ନାହିଁ। ହୁଏତ କେହି ନେଇ ସାରିଛନ୍ତି।", Urdu: "اس بیٹل میں شامل نہیں ہو سکے۔ شاید کسی نے لے لی۔",
  },
  notPartOfBattle: {
    English: "You are not part of this battle.", Hindi: "आप इस बैटल का हिस्सा नहीं हैं।", Gujarati: "તમે આ બેટલનો ભાગ નથી.", Marathi: "तुम्ही या बॅटलचा भाग नाही.",
    Tamil: "நீங்கள் இந்த போட்டியின் பகுதி அல்ல.", Telugu: "మీరు ఈ బ్యాటిల్‌లో భాగం కాదు.", Kannada: "ನೀವು ಈ ಬ್ಯಾಟಲ್‌ನ ಭಾಗವಲ್ಲ.", Bengali: "আপনি এই ব্যাটলের অংশ নন।",
    Punjabi: "ਤੁਸੀਂ ਇਸ ਬੈਟਲ ਦਾ ਹਿੱਸਾ ਨਹੀਂ ਹੋ।", Odia: "ଆପଣ ଏହି ବ୍ୟାଟଲର ଅଂଶ ନୁହଁନ୍ତି।", Urdu: "آپ اس بیٹل کا حصہ نہیں ہیں۔",
  },
  alreadyAnswered: {
    English: "You have already submitted answers for this battle.", Hindi: "आपने इस बैटल के जवाब पहले ही जमा कर दिए हैं।", Gujarati: "તમે આ બેટલ માટે જવાબો પહેલાથી જ સબમિટ કર્યા છે.", Marathi: "तुम्ही या बॅटलसाठी उत्तरे आधीच सबमिट केली आहेत.",
    Tamil: "இந்த போட்டிக்கான பதில்களை ஏற்கனவே சமர்ப்பித்துவிட்டீர்கள்.", Telugu: "ఈ బ్యాటిల్ కోసం మీరు ఇప్పటికే సమాధానాలు సమర్పించారు.", Kannada: "ಈ ಬ್ಯಾಟಲ್‌ಗಾಗಿ ನೀವು ಈಗಾಗಲೇ ಉತ್ತರಗಳನ್ನು ಸಲ್ಲಿಸಿದ್ದೀರಿ.", Bengali: "আপনি ইতিমধ্যে এই ব্যাটলের জন্য উত্তর জমা দিয়েছেন।",
    Punjabi: "ਤੁਸੀਂ ਇਸ ਬੈਟਲ ਲਈ ਪਹਿਲਾਂ ਹੀ ਜਵਾਬ ਜਮ੍ਹਾਂ ਕਰ ਚੁੱਕੇ ਹੋ।", Odia: "ଆପଣ ଏହି ବ୍ୟାଟଲ ପାଇଁ ଉତ୍ତର ପୂର୍ବରୁ ଦାଖଲ କରିସାରିଛନ୍ତି।", Urdu: "آپ نے اس بیٹل کے جوابات پہلے ہی جمع کر دیے ہیں۔",
  },
  noCompletedBattles: {
