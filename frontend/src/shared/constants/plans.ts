...
export type TabKey = 'home' | 'learn' | 'practice' | 'profile' | 'notebook' | 'learntv' | 'labs' | 'squads' | 'mistakes' | 'battles' | 'coach'
...
export const PLANS: Record<PlanType, Plan> = {
  ...
  basic: {
    ...
    icon: '⭐',
    color: '#FFD166',
    tabs: ['home', 'learn', 'practice', 'profile', 'coach', 'notebook', 'mistakes', 'battles'],
    labs: [],
    aiCallsPerDay: 50,
  },
  pro: {
    ...
    icon: '🚀',
    color: '#7B9CFF',
    tabs: ['home', 'learn', 'practice', 'profile', 'coach', 'notebook', 'learntv', 'labs', 'squads', 'mistakes', 'battles'],
