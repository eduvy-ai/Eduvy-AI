...
export type TabKey = 'home' | 'videos' | 'notebook' | 'learntv' | 'labs' | 'squads' | 'mistakes' | 'battles' | 'videocreator' | 'coach'
...
export const PLANS: Record<PlanType, Plan> = {
  free: {
    ...
    icon: '🆓',
    color: '#6868a0',
    tabs: ['home', 'coach', 'mistakes', 'battles'],
    labs: [],
    aiCallsPerDay: 10,
  },
  basic: {
    ...
    icon: '⭐',
    color: '#FFD166',
    tabs: ['home', 'coach', 'videos', 'notebook', 'videocreator', 'mistakes', 'battles'],
    labs: [],
    aiCallsPerDay: 50,
  },
  pro: {
    ...
    icon: '🚀',
    color: '#7B9CFF',
    tabs: ['home', 'coach', 'videos', 'notebook', 'learntv', 'labs', 'videocreator', 'squads', 'mistakes', 'battles'],
